...
def expand_df_with_dates(filtered_df, start_date_str, end_date_str):
    ...
    Returns:
        pd.DataFrame: Expanded DataFrame with 'Date' column
    """
...
expanded_df = expand_df_with_dates(df, start_date, end_date)

# Display the result
print(expanded_df.head())

# Save to new Excel file
expanded_df.to_excel('expanded_with_dates.xlsx', index=False)
